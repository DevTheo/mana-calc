...
import { HgmParameters, HgmResults } from "../models/HgmModels.ts";
import {combinations} from "mathjs";

export class HgmCalculatorService {
    ...
    public getHgmDistribution(params: HgmParameters): HgmResults {
      ...
      for (let i = 0; i <= params.sampleSize; i++ ) {
        ...
        this.probabilities.set(i, this.hgmProbability(params));
      }
      return {
    ...
    public hgmProbability(params: HgmParameters): number {
      /*
